...
function bindLogin() {
  ...
  elements.loginForm.addEventListener("submit", async (event) => {
    ...
    if (!name || !phone || !email || !intent) {
      elements.loginStatus.textContent = "Please complete name, phone, email, and Buy/Rent/Sell. / Completa nombre, telefono, correo y Comprar/Rentar/Vender.";
      return;
    }

    elements.loginStatus.textContent = "Opening website... / Abriendo pagina...";
